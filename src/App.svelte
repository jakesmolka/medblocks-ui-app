...
<main>
	...
	<p>This is an openEHR form.</p>

	<p>EHR ID:</p>
	<sl-input bind:this={ehrIdInput} placeholder="EHR ID" clearable></sl-input>

	<h2>Addiction Alcohol</h2>
	...
	<mb-form bind:this={form}>
		...
		<!-- <mb-input
			...
			label="Comment"
		/> -->
		<mb-context path="result_report/alcohol_use:0/any_event/time" />
		<mb-input
		...
		<!-- <mb-input
			...
			label="Comment"
		/> -->
		<mb-context path="result_report/alcohol_use:0/specified_day:0/time" />
